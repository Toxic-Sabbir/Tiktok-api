...
class TikToksAPI:
    def __init__(
        ...
        self.params = {
            ...
            'app_language': 'en', 
            'app_type': 'normal', 
            'iid': 7183409061831001857 if custom_device_id == None else custom_device_id['iid'], 
            'channel': 'googleplay', 
            ...
            'carrier_region': 'BE', 
            'ac': 'wifi', 
            'device_id': 7147445232161539590 if custom_device_id == None else custom_device_id['did'], 
            'mcc_mnc': 20610, 
            'os_version': 9, 
